    ...
    <>
      <div className='space-y-5 mb-5'>
        <Button
          ...
          className='w-full h-14 text-base font-medium bg-white hover:bg-gray-100 text-gray-900 border-0 shadow-md rounded-xl'
        >
          {isGooglePending ? (
            <span className='flex items-center gap-2'>
              <span className='w-4 h-4 border-2 border-gray-400/40 border-t-gray-700 rounded-full animate-spin' />
              {t('sending')}
            </span>
          ) : (
            <span className='flex items-center gap-2'>
